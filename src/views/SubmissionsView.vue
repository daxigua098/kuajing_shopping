...
<template>
  <div>
    ...
    <section v-else class="stats-grid">
      ...
      <article class="stat-card"><div class="stat-top"><span class="stat-label">当前角色</span><span class="stat-icon"><Icon name="shield" :size="16"/></span></div><div class="stat-value" style="font-size:20px">{{ currentUser?.roleLabel }}</div><div class="stat-foot">公司审核与开店权限</div></article>
    </section>
