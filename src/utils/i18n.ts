...
const dictionary: Record<string, Translation> = {
  ...
  '账号管理': ['Account Management', 'Pengurusan Akaun'],
  '下级账号': ['Sub-accounts', 'Akaun Bawahan'],
  '合作公司': ['Partner Companies', 'Syarikat Rakan'],
  '账号类型': ['Account Type', 'Jenis Akaun'],
  '公司账号': ['Company Account', 'Akaun Syarikat'],
  '顶级代理账号': ['Top Agent Account', 'Akaun Ejen Utama'],
  '子代理账号': ['Sub-agent Account', 'Akaun Sub-ejen'],
  '账号名称': ['Account Name', 'Nama Akaun'],
  '绑定对象': ['Bound To', 'Dipautkan Kepada'],
  '绑定公司': ['Bound Company', 'Syarikat Dipautkan'],
  '绑定顶级代理': ['Bound Top Agent', 'Ejen Utama Dipautkan'],
  '所属顶级代理': ['Top Agent', 'Ejen Utama'],
  '绑定子代理': ['Bound Sub-agent', 'Sub-ejen Dipautkan'],
  '初始密码': ['Initial Password', 'Kata Laluan Awal'],
  '重置密码': ['Reset Password', 'Tetap Semula Kata Laluan'],
  '重置账号密码': ['Reset Account Password', 'Tetap Semula Kata Laluan Akaun'],
  '停用账号': ['Disable Account', 'Nyahaktif Akaun'],
  '启用账号': ['Enable Account', 'Aktifkan Akaun'],
  '删除账号': ['Delete Account', 'Padam Akaun'],
  '首次改密': ['First Password Change', 'Tukar Kata Laluan Pertama'],
  '最后登录': ['Last Login', 'Log Masuk Terakhir'],
  '创建人 / 时间': ['Created By / Time', 'Dicipta Oleh / Masa'],
  '账号与业务分离': ['Account and Business Separation', 'Pengasingan Akaun dan Perniagaan'],
  '历史合作公司': ['Historical Partner Companies', 'Syarikat Rakan Sejarah'],
...
const extendedDictionary: Record<'th' | 'vi', Record<string, string>> = {
  th: {
    ...
    '账号管理': 'จัดการบัญชี', '下级账号': 'บัญชีลูกข่าย', '合作公司': 'บริษัทร่วมงาน', '账号类型': 'ประเภทบัญชี', '公司账号': 'บัญชีบริษัท', '顶级代理账号': 'บัญชีตัวแทนระดับสูง', '子代理账号': 'บัญชีตัวแทนย่อย', '账号名称': 'ชื่อบัญชี', '绑定对象': 'ผูกกับ', '初始密码': 'รหัสผ่านเริ่มต้น', '重置密码': 'รีเซ็ตรหัสผ่าน', '停用账号': 'ระงับบัญชี', '启用账号': 'เปิดใช้งานบัญชี', '删除账号': 'ลบบัญชี', '首次改密': 'เปลี่ยนรหัสครั้งแรก', '最后登录': 'เข้าสู่ระบบล่าสุด',
  ...
  vi: {
    ...
    '账号管理': 'Quản lý tài khoản', '下级账号': 'Tài khoản cấp dưới', '合作公司': 'Công ty hợp tác', '账号类型': 'Loại tài khoản', '公司账号': 'Tài khoản công ty', '顶级代理账号': 'Tài khoản đại lý cấp cao', '子代理账号': 'Tài khoản đại lý con', '账号名称': 'Tên tài khoản', '绑定对象': 'Liên kết với', '初始密码': 'Mật khẩu ban đầu', '重置密码': 'Đặt lại mật khẩu', '停用账号': 'Vô hiệu hóa tài khoản', '启用账号': 'Kích hoạt tài khoản', '删除账号': 'Xóa tài khoản', '首次改密': 'Đổi mật khẩu lần đầu', '最后登录': 'Đăng nhập cuối',
